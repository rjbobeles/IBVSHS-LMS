    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-5 col-md-5 text-right">User ID:</div>
                    ...
                    <div class="row">
                        <div class="col-5 col-md-5 text-right">Email Verified At:</div>
                    ...
                    <div class="row">
                        <div class="col-5 col-md-5 text-right">Username:</div>
                    ...
                    <div class="row">
                        <div class="col text-center" style="padding-top: 20px;">
                            <a href="{{ route('users.index', $user->id) }}" class="btn btn-secondary">Back to Users List</a>

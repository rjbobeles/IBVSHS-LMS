...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Edit a Patron') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('patrons.update', $patrons->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="role" name="role" class="form-control @error('role') is-invalid @enderror" required autofocus>
                                    ...
                                    <option value="Student" @if($patrons->role == "Student") {{'selected'}} @endif>Student</option>
                                    <option value="Teacher" @if($patrons->role == "Teacher") {{'selected'}} @endif>Teacher</option>
                                </select>
